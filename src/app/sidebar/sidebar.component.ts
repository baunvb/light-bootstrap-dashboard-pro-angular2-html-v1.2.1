...
export const ROUTES: RouteInfo[] = [{
        ...
        icontype: 'pe-7s-date',
        children: [
            {path: 'homestay', title: 'Homestay & Hotel', ab: 'HS'},
            {path: 'station', title: 'Station', ab: 'ST'}
        ]
    }
];
...
export class SidebarComponent {
    ...
    ngAfterViewInit() {
        let $sidebarParent = $('.sidebar .nav > li.active .collapse li.active > a').parent().parent().parent();
